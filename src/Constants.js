...
exports.GiveawayMessages = {
    ...
    inviteToParticipate: 'Click in the button to participate!',
    winMessage: 'Congratulations, {winners}! You won **{this.prize}**!',
    drawing: 'Drawing: {timestamp}',
    dropMessage: 'Be the first to click the button !',
 ...
 * @property {Discord.EmojiIdentifierResolvable} [default.buttonText='Enter'] The text of button to participate in giveaways.
